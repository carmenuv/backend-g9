class Producto:
  def __init__(self, nombre, precio, cantidad):
    ...
    # __atributo > estaremos indicando que será privado y por ende no puede ser accedido desde fuera de la clase PRIVADO
    self.__ventas = []
...
detergente.generar_venta(fecha='2022-10-30', cliente='Franco Portugal', cantidad=10)
