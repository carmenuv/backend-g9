...
# Aca inicializamos la clase Api que nos servirá para poder utilizar todos los controladores dentro de la aplicación de Flask
api = Api(app)

# la conexión a la base de datos que usará SQLALCHEMY para conectarse
app.config['SQLALCHEMY_DATABASE_URI'] = environ.get('DATABASE_URI')

# mostrará todas las consultas en lenguaje SQL que se realiza a la base de datos
...
# Inicializamos la clase Migrate con la configuración de nuestra base de datos y aplicación de Flask
