...
class DepartamentoModel(models.Model):
  ...
  # si nosotros no declaramos el Autofield Django de manera predeterminada creará una coumna llamada 'id' que sea autoincrementable
  ...
  class Meta:
    # pasarle metadata o información adicional a la clase de la cual estamos heredando
    #https://docs.djangoproject.com/en/4.1/ref/models/options/
    db_table = 'departamentos'

class AlmacenModel(models.Model):
  # https://docs.djangoproject.com/en/4.1/ref/models/fields/#choices
  # se declara una lista de tuplas en la cual el primer valor de cada tupla será lo que se guardará en la base de datos, mientras que el segundo valor será lo que el usuario leerá al devolver la información
  ...
  # tipo = models.CharField(max_length=100, choices=TipoAmacenOpciones.choices)
  ...
  class Meta:
    # db_table > indica como se llamará esta tabla en la base de datos, si no le indicamos usará el nombre de la clase como nombre de la tabla. Para esto, si o si se ussará class Meta:
    db_table = 'almacenes'